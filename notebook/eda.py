...
# %%
train = pd.read_pickle(data_dir + "cluster_train.pkl")
...
train_m[features] = train_m[features].astype(np.float64)
test_m[features] = test_m[features].astype(np.float64)
...
# %%
test_m["trade_order_count_sum_0c1"]
# %%
train_m["trade_order_count_sum_0c1"].mean()
# %%
test_m.isna().sum()
# %%
test_m.iloc[test_m.dtypes == "Int16Dtype()"]
# %%
test_m["trade_order_count_sum_0c1"]
# %%
test_m.dtypes.values
# %%
test_m[features].fillna(np.inf)
# %%
